...
//	@PostMapping("/fromCatalog")
//	public /*ResponseEntity<Movie>*/void saveFromCatalog(@RequestBody MovieWS movieDTO) {
////		return ResponseEntity.ok().body(movieService.save(movie));
//		movieService.handleQueueMovieMessageReception(movieDTO);
//	}
